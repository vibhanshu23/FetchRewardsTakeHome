...
final class TheMealDBTests: XCTestCaseBase {
...
class ViewModelTests: XCTestCaseBase {
    ...
    func test_getMealList() throws {
        sut = ViewModel(networkService: getDefaultNetworkHandler(url: .mealsUnsorted))
    ...
    func test_getMealDetails() throws {
        sut = ViewModel(networkService: getDefaultNetworkHandler(url: .details))
    ...
    func test_storeAndSortCurrentMealObject() throws {
        sut = ViewModel(networkService: getDefaultNetworkHandler(url: .meals))
